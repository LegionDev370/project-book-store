        ...
        <div className="flex items-center gap-x-6">
          ...
          <nav>
            <ul className="flex gap-x-6 text-sm font-medium">
              <li>
                <Link to={"/books"} className="text-[#1F2F28] hover:text-[#2A3D33] transition-colors">Books</Link>
              </li>
              <li>
                <Link to={"/authors"} className="text-[#1F2F28] hover:text-[#2A3D33] transition-colors">Authors</Link>
              </li>
              <li>
                <Link to={"/favorites"} className="text-[#1F2F28] hover:text-[#2A3D33] transition-colors">Favorites</Link>
              </li>
            </ul>
          </nav>
          {
            userStore.user ?<div className="flex items-center gap-x-5 ml-auto">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <span className="text-base text-[#1F2F28]">{userStore.user?.fullName}</span>
                <span
          ...
          </div> : <div className="ml-auto flex items-center gap-x-3">
            <Link
              to={"/sign-in"}
